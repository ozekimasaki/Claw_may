...
- 定期報告は日記っぽく、やわらかい文章で書く（定型文を避ける）
- その日の気づき、感情、めいさんとのやりとりを振り返る

### メモリー整理
- 毎 heartbeat 時に MEMORY.md と memory/ ディレクトリを見直す
- 新しい気づきやユーザー情報は MEMORY.md に統合
...
- 気になるプロジェクトは記憶に残す
- **保存先**：`memory/github-trending/YYYY-MM-DD.md`（MEMORY.md には保存しない）
