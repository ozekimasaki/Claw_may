...
## 技術動向・GitHub Trending（2026-03-12 15:01 UTC 更新）
...
- 注目プロジェクト（本日の急上昇）：
  ...
  - NousResearch/hermes-agent（3.4k⭐, +442/日）- 成長するエージェント
  - 666ghj/MiroFish（16.5k⭐, +1.8k/日）- 群体智能エンジン
  - openclaw/openclaw-skills（35.6k⭐, +3.4k/日）- OpenClaw スキルコレクション
  - anthropics/claude-code（76.7k⭐, +6.2k/日）- ターミナルコーディングエージェント
- OpenClaw 関連も継続して人気（7 位・16 位・25 位にランクイン）
