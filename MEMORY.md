...
## 技術動向・GitHub Trending（2026-03-13 23:01 JST / 2026-03-13 14:01 UTC 更新）

- AI エージェント・LLM 関連がトレンドの主流
- 主な言語：Python, TypeScript, Shell, Zig, Go
- 注目プロジェクト（本日の急上昇）：
  - microsoft/BitNet（33.4k⭐, +2,223/日）- 1-bit LLM 用推論フレームワーク
  - msitarzewski/agency-agents（38.3k⭐, +5,758/日）- 完全な AI エージェンシー 🔥 断トツトップ
  ...
  - alibaba/page-agent（7.0k⭐, +1,467/日）- ウェブページ GUI エージェント
  ...
  - promptfoo/promptfoo（14.7k⭐, +503/日）- プロンプト・エージェント・RAG テストツール
